...
export const seedLeads: Lead[] = [
  {
    id: 'LD-1048', company: 'SAMPLE-CLIENT-01', contact: 'DEMO-CONTACT-01', email: 'demo01@example.test',
    stage: 'proposal', priority: 'high', value: 4200000, owner: 'OWNER-A', source: 'Website', dueOffset: 0,
  ...
  {
    id: 'LD-1047', company: 'SAMPLE-CLIENT-02', contact: 'DEMO-CONTACT-02', email: 'demo02@example.test',
    stage: 'qualified', priority: 'high', value: 6800000, owner: 'OWNER-A', source: 'Referral', dueOffset: 1,
  ...
  {
    id: 'LD-1046', company: 'SAMPLE-CLIENT-03', contact: 'DEMO-CONTACT-03', email: 'demo03@example.test',
    stage: 'new', priority: 'medium', value: 1900000, owner: 'OWNER-B', source: 'Wishket', dueOffset: 2,
  ...
  {
    id: 'LD-1045', company: 'SAMPLE-CLIENT-04', contact: 'DEMO-CONTACT-04', email: 'demo04@example.test',
    stage: 'negotiation', priority: 'high', value: 9300000, owner: 'OWNER-A', source: 'Upwork', dueOffset: -1,
  ...
  {
    id: 'LD-1044', company: 'SAMPLE-CLIENT-05', contact: 'DEMO-CONTACT-05', email: 'demo05@example.test',
    stage: 'won', priority: 'medium', value: 3600000, owner: 'OWNER-B', source: 'Contra', dueOffset: 4,
  ...
  {
    id: 'LD-1043', company: 'SAMPLE-CLIENT-06', contact: 'DEMO-CONTACT-06', email: 'demo06@example.test',
    stage: 'proposal', priority: 'medium', value: 2800000, owner: 'OWNER-A', source: 'Website', dueOffset: 3,
  ...
  {
    id: 'LD-1042', company: 'SAMPLE-CLIENT-07', contact: 'DEMO-CONTACT-07', email: 'demo07@example.test',
    stage: 'qualified', priority: 'low', value: 1400000, owner: 'OWNER-B', source: 'Email', dueOffset: 5,
  ...
  {
    id: 'LD-1041', company: 'SAMPLE-CLIENT-08', contact: 'DEMO-CONTACT-08', email: 'demo08@example.test',
    stage: 'new', priority: 'low', value: 2200000, owner: 'OWNER-A', source: 'LinkedIn', dueOffset: 6,
